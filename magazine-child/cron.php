...
// 	$caption = mysqli_real_escape_string($connection, $value['caption']['text']);
	...
	$query = "INSERT IGNORE INTO selfie_info (`key`, `app`, `thumbnail`, `standard`, `user`, `GPS`, `locationName`, `caption`, `timestamp`) " . 
...
include '/home/iculture/public_html/saveaselfie/wp-content/themes/magazine-child/Twitter-php/RestApi.php';
// echo E_WARNING;

$consumerKey = 'NYn3vyXBtmBQBlqMvpMjxswWz';
$consumerSecret = 'CxkbuyWjH4ktyANFv0NV4sNZ9rbm0CFR3II2pfk7qAiOsgbcGP';
$accessToken = '606748020-0icy2E8T5CBtsS2wDCYFKE9QhvmhOo9SvyPIQZi1';
$accessTokenSecret = 'lzEcOeFnfteOp9wsvhJZ78h5P5gaJW0wsofLjaJZCDJND';
...
// 	if ($first) {
// 	if ($first) { echo "twitter: <pre>"; print_r($tweet); echo "</pre>\n"; break; }
...
//   $caption = mysqli_real_escape_string($connection, $caption);
  if ($latitude) {
	...
	// 	echo "<img src=\"$image\"><br>\n";
		...
		$query = "INSERT IGNORE INTO selfie_info (`key`, `app`, `thumbnail`, `standard`, `user`, `GPS`, `locationName`, `caption`, `timestamp`)" . 
				 " VALUES ('$key', 'twit', '$localThumb', '$localNormal', '$uploadedBy', GeomFromText( 'POINT($latitude $longitude)'), '', '$caption', '$datetime')";
// 		echo "query is $query<br>\n";
		$result = doQuery2($query);
		checkResult($query, $result);
...
// 			$url = 'http://iculture.info/defib/infoReceiver.php'; // for testing
