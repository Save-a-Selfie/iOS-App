...
- (void)layoutSubviews {
	...
	CGSize detailsLabelSize =
		[label.text length] > 0 ? [label.text boundingRectWithSize:maxSize options:(NSStringDrawingUsesLineFragmentOrigin)
									attributes:@{NSFontAttributeName:label.font} context:nil].size : CGSizeZero;
