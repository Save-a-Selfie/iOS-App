<div id="floatingBox"><img id="floatingImage" src=""><div id="floatingCaption"></div><div id="floatingMap"></div><div id="x">X</div>
...
while ($row = mysqli_fetch_array($result, MYSQL_ASSOC)) {
	...
	if (isset($homePageMax)) if ($count >= $homePageMax) break;
// 	echo "count is $count ($homePageMax)<br>\n";
}
...
function useRowValues($row, $count) {
	...
	if ($latitude) {
		...
		$info2 = "<script>defib[$count]={}; defib[$count]['typeOfObject'] = '$typeOfObject'; defib[$count]['caption']=\"$caption\"; defib[$count]['address']=\"\"; defib[$count]['lng']=\"$longitude\";" . 
