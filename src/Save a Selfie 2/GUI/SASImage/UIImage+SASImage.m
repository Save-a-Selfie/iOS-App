...
// This is the key for the regular sized image.
NSString* const KeyForLargeImage = @"LARGE_IMAGE";
// This is the key for the thumbnail sized image.
...
+ (NSDictionary *) createLargeImageAndThumbnailFromSource:(UIImage *) image {
  ...
  return [[NSDictionary alloc] initWithObjectsAndKeys:standardImage, KeyForLargeImage, thumbnailImage, KeyForThubnailImage, nil];
