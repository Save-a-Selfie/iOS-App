...
- (void) downloadDevices {
  ...
  [self.networkManager downloadWithQuery:query forWorker:downloadWorker completion:^(NSArray *devices) {
    
  }];
}

- (void) generateAnnotationsFromDeviceInformation: (NSArray <SASDevice*> *device) devices {
