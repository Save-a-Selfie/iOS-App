...
+ (NSArray *) allCards {
    ...
    [saveSelfie.button setTitle:@"See website" forState:UIControlStateNormal];
    ...
    [fireBrigade.button setTitle:@"See website" forState:UIControlStateNormal];
    ...
    [codeForIreland.button setTitle:@"See website" forState:UIControlStateNormal];
    ...
    [adamsGift.button setTitle:@"See website" forState:UIControlStateNormal];
    ...
    [emergencyCare.button setTitle:@"See website" forState:UIControlStateNormal];
