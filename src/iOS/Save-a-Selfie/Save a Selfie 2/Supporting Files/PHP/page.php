	...
	<div id="content" class="clearfix">
		...
		<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
			...
			<div class="page-content entry-content" itemprop="articleBody">
				...
				$title = get_the_title();
				if ($title == 'Home') {
					$homePageMax = 12; echo "<script>var homePageMax = $homePageMax, homePageRows = 2;</script>\n";
					require get_stylesheet_directory() . '/galleryAndMaps.php';
				}
				if (($title == 'Map') || ($title == 'MapX')) {
					$selfiesPlusMap = true; $mapOnly = true;
					require get_stylesheet_directory() . '/galleryAndMaps.php';
				}
				if ($title == 'Gallery') {
					$selfiesPlusMap = true; $mapOnly = true;
